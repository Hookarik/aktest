...
# --------------------------------------------------
# grandfantasia - 006.758.80.80
# --------------------------------------------------
if [ "$DSVERSION" = 1 ] ; then
	cd "/root/gf"
	wget --no-check-certificate "https://raw.githubusercontent.com/hookarik/aktest/master/grandfantasia_006_758_80_80" -O "grandfantasia_006_758_80_80"
	chmod 777 grandfantasia_006_758_80_80
	. "/root/gf/grandfantasia_006_758_80_80"
	...
	rm -f grandfantasia_006_758_80_80
	
	# setup info
	VERSIONNAME="grandfantasia - 006.758.80.80"
