...
## How to use?
The script is intended for use on [debian11-server](http://download.g0tmi1k.com/iso/Debian/) or [debian11-desktop](https://cdimage.debian.org/cdimage/unofficial/non-free/cd-including-firmware/archive/). The command to download and run this script is the following:
