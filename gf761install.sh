...
# --------------------------------------------------
# grandfantasia - 006.761.80.80
# --------------------------------------------------
if [ "$DSVERSION" = 1 ] ; then
	cd "/root/gf"
	wget --no-check-certificate "https://raw.githubusercontent.com/hookarik/aktest/master/grandfantasia_006_761_80_80" -O "grandfantasia_006_761_80_80"
	chmod 777 grandfantasia_006_761_80_80
	. "/root/gf/grandfantasia_006_761_80_80"
	...
	sudo -u postgres psql -d GFAccount -c "\i '/root/gf/SQL/fortune_bag.sql';"
	sudo -u postgres psql -d GFAccount -c "\i '/root/gf/SQL/elf_lottery.sql';"
	sudo -u postgres psql -d GFAccount -c "\i '/root/gf/SQL/high_lottery.sql';"
	...
	rm -f grandfantasia_006_761_80_80
	
	# setup info
	VERSIONNAME="grandfantasia - 006.761.80.80"
	CREDITS="X-Legends"
